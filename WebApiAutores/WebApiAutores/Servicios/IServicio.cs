namespace WebApiAutores.Servicios {
	public interface IServicio {
		Guid ObtenerTransient { get; }
		Guid ObtenerScoped { get; }
		Guid ObtenerSingleton { get; }
	...
	public class ServicioB: IServicio {
		public Guid ObtenerTransient => throw new NotImplementedException();

		public Guid ObtenerScoped => throw new NotImplementedException();

		public Guid ObtenerSingleton => throw new NotImplementedException();
